...
% Script to plot Figures 19, 20, and 21
...
% subplot(7,1,1);
plot(t,trace,'y','linewidth',5); hold on
% legend('Raw');
xlabel('Time (s)')
ylabel('Amplitude')
 ylim([-450 600])
...
%figure;
% subplot(7,1,2);
plot(t,trace1,'m','linewidth',5); hold on
% legend('MF');
xlabel('Time (s)')
ylabel('Amplitude')
 ylim([-450 600])
...
%figure;
% subplot(7,1,3);
plot(t,trace2,'k','linewidth',5); hold on
% legend('MF+LOW (LO)');
xlabel('Time (s)')
ylabel('Amplitude')
 ylim([-450 600])
...
trace3 = d_somf(:,inds);
% subplot(7,1,4)
plot(t,trace3,'b','linewidth',5); hold on
% legend('SOMF');
% xlim([1 2500])
xlabel('Time (s)')
ylabel('Amplitude')
...
% subplot(7,1,5)
plot(t,trace4,'c','linewidth',5); hold on
% legend('SOMF+LOW (LO)');
% xlim([1 2500])
xlabel('Time (s)')
ylabel('Amplitude')
...
% subplot(7,1,6)
plot(t,trace5,'g','linewidth',5); hold on
% legend('SOSVMF');
% xlim([1 2500])
xlabel('Time (s)')
ylabel('Amplitude')
...
% subplot(7,1,7)
plot(t,trace6,'r','linewidth',5); hold on
% xlim([1 2500])
xlabel('Time (s)')
ylabel('Amplitude')
 ylim([-300 500])
%  text(-0.05,1000,'(g)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
legend('Raw','MF','MF+LOW (LO)','SOMF','SOMF+LOW (LO)','SOSVMF','SOSVMF+LOW (LO)');
set(gca,'Linewidth',4,'Fontsize',30,'Fontweight','bold');
annotation(gcf,'line',[0.318011143410853 0.317229893410853],...
    [0.209175738724728 0.674961119751166],...
    'Color',[0.501960784313725 0.501960784313725 0.501960784313725],...
    'LineWidth',8);
annotation(gcf,'textbox',...
    [0.388941375968993 0.52177293934681 0.407812500000001 0.0544323483670296],...
    'String','                              P wave arrival',...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.556904069767443 0.600654069767444],...
    [0.559875583203733 0.559875583203733],...
    'Color',[0.501960784313725 0.501960784313725 0.501960784313725],...
    'LineWidth',8);
%% S/N estimation
