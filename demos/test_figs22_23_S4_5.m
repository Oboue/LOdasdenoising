...
figure('units','normalized','Position',[0.0 0.0 0.5 1],'color','w'); hold on
% subplot(9,1,1);
plot(t,trace,'g','linewidth',6); hold on
legend('Raw');
xlabel('Time (s)')
ylabel('Amplitude')
 ylim([-450 450])
...
%figure;
% subplot(9,1,2);
plot(t,trace1,'y','linewidth',6); hold on
...
%figure;
% subplot(9,1,3);
plot(t,trace2,'--','linewidth',6); hold on
...
trace3 = d_bpfkcurvelet(:,inds);
% subplot(9,1,4)
plot(t,trace3,'cyan','linewidth',6); hold on
...
trace4 = d_bpfkcurveletlow(:,inds);
% subplot(9,1,5)
plot(t,trace4,'k','linewidth',6); hold on
...
% subplot(9,1,6)
plot(t,trace5,'m','linewidth',6); hold on
% legend('BP+SOSVMF+FK');
% xlim([1 2500])
xlabel('Time (s)')
ylabel('Amplitude')
...
% subplot(9,1,7)
plot(t,trace6,'b','linewidth',6); hold on
...
% subplot(9,1,8)
plot(t,trace7,'w','linewidth',6); hold on
...
% subplot(9,1,9)
plot(t,trace8,'r','linewidth',6); hold on
...
%  text(-0.08,500,'(i)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
 legend('Raw','SOSVMF+FK+Curvelet','SOSVMF+FK+Curvelet+LOW (LO)','BP+FK+Curvelet','BP+FK+Curvelet+LOW (LO)','BP+SOSVMF+FK','BP+SOSVMF+FK+LOW (LO)','BP+SOSVMF+FK+Curvelet','BP+SOSVMF+FK+Curvelet+LOW (LO)');
set(gca,'Linewidth',4,'Fontsize',25,'Fontweight','bold');
annotation(gcf,'textbox',...
    [0.473437500000001 0.509331259720062 0.407812500000001 0.0544323483670296],...
...
subplot(2,2,1);LO_imagesc(d_sosvmffkcurvelet,100,2,x,t);caxis([-60,60]); hold on
...
text(n2/0.65,-0.03,'SOSVMF+FK+Curvelet','color','k','Fontsize',17,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(a)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');

subplot(2,2,2);LO_imagesc(dn1,100,2,x,t);caxis([-60,60]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.03,'Removed noise','color','k','Fontsize',17,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(b)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');

subplot(2,2,3);LO_imagesc(d_sosvmffkcurveletlow,100,2,x,t);caxis([-60,60]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.03,'SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',17,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(c)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');

subplot(2,2,4);LO_imagesc(dn2,100,2,x,t);caxis([-60,60]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.03,'Removed noise','color','k','Fontsize',17,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(d)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');

%%
figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
subplot(3,4,1);LO_imagesc(d_bpfkcurvelet,100,2,x,t);
...
%text(n2/3.5,-0.09,'Raw data','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(n2/0.65,-0.035,'BP+FK+Curvelet','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(a)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.2421875 0.25546875],...
    [0.838813374805599 0.864696734059098],'Color',[1 0 0],...
...
subplot(3,4,2);LO_imagesc(dn3,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(b)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.396875 0.37421875],...
    [0.86058631415241 0.889580093312597],'Color',[1 0 0],...
...
subplot(3,4,3);LO_imagesc(d_bpfkcurveletlow,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'BP+FK+Curvelet+LOW (LO)','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(c)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.654687500000001 0.667968750000001],...
    [0.85203265940902 0.877916018662519],'Color',[1 0 0],...
    'String',{'Strong','erratic','noise'},...
    'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
...
subplot(3,4,4);LO_imagesc(dn4,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(d)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.810156250000001 0.787500000000001],...
    [0.86058631415241 0.889580093312597],'Color',[1 0 0],...
    'String',{'Stronger','signal','leakage'},...
    'LineWidth',2,...
    'HeadWidth',15,...
...
subplot(3,4,5);LO_imagesc(d_bpsosvmffk,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
%text(n2/3.5,-0.09,'Raw data','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(n2/0.65,-0.035,'BP+SOSVMF+FK','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(e)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.24140625 0.2546875],...
    [0.536325038880249 0.562208398133748],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);

subplot(3,4,6);LO_imagesc(dn5,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
...
annotation(gcf,'textarrow',[0.391406250000001 0.368750000000001],...
    [0.558097978227061 0.587091757387247],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);

subplot(3,4,7);LO_imagesc(d_bpsosvmffklow,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'BP+SOSVMF+FK+LOW (LO)','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(g)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.656250000000002 0.669531250000002],...
    [0.542545878693624 0.568429237947123],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);

subplot(3,4,8);LO_imagesc(dn6,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(h)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.815625000000001 0.792968750000001],...
    [0.559653188180404 0.588646967340591],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);

subplot(3,4,9);LO_imagesc(d_bandpasssosvmffkcurvelet,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
%text(n2/3.5,-0.09,'Raw data','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(n2/0.65,-0.035,'BP+SOSVMF+FK+Curvelet','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
%text(n2/0.4,-0.09,'BP+LOW (LO)','color','k','Fontsize',14,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(i)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.23828125 0.25234375],...
    [0.262052877138414 0.283048211508554],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);

subplot(3,4,10);LO_imagesc(dn7,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
...
annotation(gcf,'textarrow',[0.397656250000001 0.375000000000001],...
    [0.258720062208398 0.287713841368585],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);
subplot(3,4,11);LO_imagesc(d_bandpasssosvmffkcurveletlow,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'BP+SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',8,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(k)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.655468750000004 0.668750000000004],...
    [0.260275272161742 0.286158631415241],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);
subplot(3,4,12);LO_imagesc(dn8,100,2,x,t);
ylabel('Time (s)','Fontsize',8,'fontweight','bold');
xlabel('Channel','Fontsize',8,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',8,'Fontweight','bold');
text(n2/0.65,-0.035,'Removed noise','color','k','Fontsize',9,'fontweight','bold','HorizontalAlignment','center');
text(-500,-0.1,'(l)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.811718750000001 0.789062500000001],...
    [0.264940902021773 0.29393468118196],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',15);
