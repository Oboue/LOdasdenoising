...
figure('units','normalized','Position',[0.0 0.0 0.5 1],'color','w');
subplot(2,2,1);LO_imagesc(eq,100,2,x,t);caxis([-25,25]); hold on
% subplot(2,3,1);LO_imagesc(simi1(inds1,:),100,2,x,t(inds1));colormap(jet);caxis([0,0.25]); hold on
...
subplot(2,2,2);LO_imagesc(d1_bpmffk,100,2,x,t);caxis([-25,25]); hold on
% subplot(2,3,1);LO_imagesc(simi1(inds1,:),100,2,x,t(inds1));colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
...
annotation(gcf,'arrow',[0.878888888888889 0.845555555555556],...
    [0.83479154375615 0.883972468043268],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.874444444444445 0.841111111111111],...
    [0.699814236792272 0.74899516107939],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.704444444444445 0.671111111111111],...
    [0.835774827925273 0.884955752212391],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);

subplot(2,2,3);LO_imagesc(d_bpsomffk,100,2,x,t);caxis([-25,25]); hold on
% subplot(2,3,1);LO_imagesc(simi1(inds1,:),100,2,x,t(inds1));colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
...
annotation(gcf,'arrow',[0.272222222222222 0.238888888888889],...
    [0.363853645659261 0.413034569946379],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.432222222222222 0.398888888888889],...
    [0.361883202309505 0.411064126596624],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.433333333333333 0.4],...
    [0.227893054526253 0.277073978813371],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);

subplot(2,2,4);LO_imagesc(d4,100,2,x,t);caxis([-25,25]); hold on
% subplot(2,3,1);LO_imagesc(simi1(inds1,:),100,2,x,t(inds1));colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.04,'BP+SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',15,'fontweight','bold','HorizontalAlignment','center');
text(-250,-0.05,'(d)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'arrow',[0.711111111111111 0.677777777777778],...
    [0.363853645659261 0.413034569946379],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.873333333333333 0.84],...
    [0.360897980634626 0.410078904921744],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
annotation(gcf,'arrow',[0.881111111111111 0.847777777777778],...
    [0.22001128112724 0.269192205414358],'Color',[1 0 0],'LineWidth',2,...
    'HeadWidth',25,...
    'HeadLength',25);
...
subplot(2,3,1);LO_imagesc(dn3,100,2,x,t);caxis([-25,25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
...
subplot(2,3,2);LO_imagesc(dn4,100,2,x,t);caxis([-25,25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
...
subplot(2,3,3);LO_imagesc(dn5,100,2,x,t);caxis([-25,25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.04,'BP+SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
text(-250,-0.05,'(c)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
%%
figure('units','normalized','Position',[0.0 0.0 1, 1],'color','w');
subplot(2,3,4);LO_imagesc(simi3,100,1,x,t);colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
...
% figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
subplot(2,3,5);LO_imagesc(simi4,100,1,x,t);colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.04,'BP+SOMF+FK','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text(-250,-0.05,'(e)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');

subplot(2,3,6);LO_imagesc(simi5,100,1,x,t);colormap(jet);caxis([0,0.25]); hold on
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Channel','Fontsize',12,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
text(n2/0.65,-0.04,'BP+SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text(-250,-0.05,'(f)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
