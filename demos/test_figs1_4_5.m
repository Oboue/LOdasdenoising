...
% Script to plot Figures 1, 4 and 5
...
ylabel('Time (s)','Fontsize',40,'fontweight','bold');
xlabel('Channel','Fontsize',40,'fontweight','bold');
set(gca,'Linewidth',4,'Fontsize',40,'Fontweight','bold');
text(n2/0.65,-0.035,'Raw DAS data','color','k','Fontsize',60,'fontweight','bold','HorizontalAlignment','center');
% text(-200,-0.05,'(a)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.240771548202615 0.223647365196078],...
    [0.531761731309801 0.452566096423018],'String',{'   Horizontal','noise'},...
    'LineWidth',10,...
    'HeadWidth',50,...
    'HeadLength',80,...
    'FontWeight','bold',...
    'FontSize',60);
annotation(gcf,'textarrow',[0.653619791666666 0.695842013888889],...
    [0.74015166165261 0.671321769813869],'String',{'High-frequency','noise'},...
    'LineWidth',10,...
    'HeadWidth',50,...
    'HeadLength',80,...
    'FontWeight','bold',...
...
annotation(gcf,'textarrow',[0.544444444444443 0.544444444444444],...
    [0.447994444127429 0.398387331550842],...
    ...
    'FontWeight','bold',...
    'FontSize',60);
annotation(gcf,'textarrow',[0.60982434640523 0.63482434640523],...
    [0.363180456129598 0.445399106711918],...
    ...
    'FontWeight','bold',...
    'FontSize',60);
annotation(gcf,'textarrow',[0.770588235294115 0.78003267973856],...
    [0.546748439244434 0.613064529721363],'String',{'Signal'},'LineWidth',10,...
    'HeadWidth',80,...
    'HeadLength',50,...
    'FontWeight','bold',...
    'FontSize',60);
...
annotation(gcf,'textarrow',[0.268055555555555 0.269166666666667],...
    [0.852253267837112 0.829409081446466],...
    'String',{'Random','background','noise'},...
    'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',20);
annotation(gcf,'textarrow',[0.264427083333333 0.2828125],...
    [0.760278989679341 0.744167962674961],...
    ...
    'FontWeight','bold',...
    'FontSize',20);
annotation(gcf,'textarrow',[0.304479166666667 0.314843750000001],...
    [0.671732578646436 0.653965785381026],...
    'String',{'High-amplitude','erratic noise'},...
    'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.22578125 0.21953125],...
    [0.609545978488593 0.660186625194401],...
    'TextColor',[0.149019607843137 0.149019607843137 0.149019607843137],...
...
annotation(gcf,'textarrow',[0.579583333333334 0.5921875],...
    [0.694815812993309 0.673405909797823],...
    'String',{'High-amplitude','erratic noise'},...
    'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
...
text(-200,-0.05,'(c)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.789722222222222 0.790833333333333],...
    [0.659742828882294 0.632512315270936],'String',{'   Horizontal','  noise'},...
    'LineWidth',2,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    [0.172041666666666 0.323698430564284 0.157645833333334 0.0741839762611269],...
    'String',{'Random background noise'},...
    'FontWeight','bold',...
    'FontSize',22,...
    'FitBoxToText','off',...
...
annotation(gcf,'textarrow',[0.54234375 0.580121527777778],...
    [0.344894970075318 0.277470140735008],...
...
xlabel('Channel','Fontsize',10,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',10,'Fontweight','bold');
text(n2/0.65,-0.025,'BP+SOSVMF+FK+Curvelet+LOW (LO)','color','k','Fontsize',10,'fontweight','bold','HorizontalAlignment','center');
text(-250,-0.07,'(f)','color','k','Fontsize',25,'fontweight','bold','HorizontalAlignment','center');
annotation(gcf,'textarrow',[0.817690972222222 0.86546875],...
    [0.352181179439951 0.277008083495343],...
...
annotation(gcf,'textbox',...
    [0.433333333333333 0.690513219284603 0.184444444444445 0.0967106665227654],...
    'String',['Erratic',sprintf('\n'),'noise'],...
    'FontWeight','bold',...
    'FontSize',35,...
    'FitBoxToText','off',...
    'EdgeColor','none');
...
annotation(gcf,'textbox',...
    [0.128036175710594 0.210115976882199 0.202222222222222 0.09949261083742],...
    'String',{'Random','background noise'},...
    'FontWeight','bold',...
    'FontSize',30,...
    'FitBoxToText','off',...
...
annotation(gcf,'textbox',...
    [0.416201550387597 0.422776784511578 0.234444444444445 0.0539590783910575],...
    'String',{'','High-frequency noise'},...
    'FontWeight','bold',...
    'FontSize',22,...
    'FitBoxToText','off',...
...
annotation(gcf,'textbox',...
    [0.495555555555555 0.372520236098014 0.163333333333333 0.0826771653543306],...
    'String',{'','+'},...
    'FontWeight','bold',...
    'FontSize',30,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.415839793281653 0.298946253413502 0.215167958656331 0.0756097125790205],...
    'String',{'High-amplitude','   Erratic  noise'},...
    'FontWeight','bold',...
    'FontSize',22,...
    'FitBoxToText','off',...
