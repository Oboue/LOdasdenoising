...
%% 
comp1=[eq,zeros(n1,ngap),d_LO1,zeros(n1,ngap),eq-d_LO1]; 

%% Process the DAS seismic data with weaker signal energy corrupted by strong noise using the LO method
%%
eq=zeros(2000,960);
[n1,n2]=size(eq);
...
comp2=[eq,zeros(n1,ngap),d_LO2,zeros(n1,ngap),eq-d_LO2]; 
...
comp3=[eq,zeros(n1,ngap),d_LO3,zeros(n1,ngap),eq-d_LO3]; 
%%
%% Plot figures 
