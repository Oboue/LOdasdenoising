function [w,diag,offd,trace] = LO_predict_step(e,nw,adj,forw,n1,pp,trace)
%LO_predict_step: prediction ste
%
% INPUT:
%
...
[diag,offd] = LO_regularization(diag,offd,nw,eps,eps2);
...
[w,diag,offd] = LO_pwd_define(forw,diag,offd,n1,nw,pp);
% [diag,offd]
   
if adj
   trace = LO_banded_solve(n1,nb,diag,offd,trace);
end
...
[trace] = LO_pwd_set(adj,w,diag,offd,pp,trace);%?
